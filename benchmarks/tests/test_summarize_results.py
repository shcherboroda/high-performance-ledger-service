...
def result(valid=True):
    ...
    return {"schema_version": 5, "scenario": "independent", "seed": 1, "commit_sha": "abc", "effective_database_pool": {"max_connections_per_instance": 32}, "topology_levels": [{"configured_instances": 1, "service_urls": ["http://a"], "valid": valid, "levels": [level]}]}
